...
module.exports = {
  ...
  execute(message, args, id) {
    if (functions.endgameCheck(id, message)) {
      switch (args[0]) {
      case "first":
        message.channel.send(`Active: \`11,21,22,31,32,33,41,42,51,61,62,73,83,93,103,111,121,131,141,151,161,162,171,181,192,201,72,82,92,102,191,211,212,193,213,214,222,223,232,225,233,228|0\`
