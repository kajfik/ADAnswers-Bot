...
module.exports = {
  ...
  execute(message, args) {
    ...
    case "r133":
    case "inltisa":
      message.channel.send(`Disable the autobuyer for the IP multiplier on the Infinity Upgrades (not Break Infinity Upgrades!) tab. See \`++r133\` on why the reward makes a difference.`);
      break;
    case "r134":
    case "wwibe":
