...
module.exports = {
  ...
  execute(message) {
    if (functions.botCommandsCheck(message.channel.id)) message.channel.send(`Hellbach: basis for most of the commands, provided much of the information used in this bot,
