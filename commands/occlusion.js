...
module.exports = {
  ...
  execute(message) {
    message.channel.send(`This guide is for performance issues when you minimize any game in chrome, and EACH option could fix the problem (it's mostly about making stuff working while minimized). High chance that just Steps 1-4 are enough (then don't try more). ALL these options can increase your cpu usage.
