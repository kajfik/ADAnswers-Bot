...
export const onesixtyoneor162: Command = {
  ...
  run: async(interaction: BaseCommandInteraction) => {
    ...
    const content: string = `Get TS161 first. Both give the same maximum bonus, but TS161 gives that bonuses more quickly as it multiplies ADs directly. Once you have EC2 clears, TS162 is slightly better as the study bonus synergises with the EC2 reward.
