...
Android version: <https://play.google.com/store/apps/details?id=kajfosz.antimatterdimensions> *Note: the Reality update is not released for mobile yet!*
Steam: <https://store.steampowered.com/app/1399720/Antimatter_Dimensions/>`,
  "mobile": "Kajfik has been hard at work on porting the Reality update; however, the update is still in the works and being tested. Please be patient!",
