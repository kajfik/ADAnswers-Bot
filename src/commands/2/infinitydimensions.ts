...
export const infinitydimensions: Command = {
  ...
  run: async(interaction: CommandInteraction) => {
    ...
    const content: string = `Infinity Dimensions are a new type of Dimension that you unlock the ability to get when you Break Infinity; however, only go for them when you have 1e8 Infinity Points. They generate Infinity Power (abb. IPow), which gives a boost to Antimatter Dimensions equivelent to IPow^7.
