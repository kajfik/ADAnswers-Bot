...
export const swipetrick: Command = {
  ...
  run: async(interaction: CommandInteraction) => {
    ...
    const content: string = `As of Android version 2.45.0, the swipe trick has been replaced with a simpler "Sticky Button" trick. After you reach Infinity for the first time on any save, you can hold down one of the bottom buttons, and it will stay held as you do other things on screen. No swiping required. Pressing the held button again will disable it. 
