...
class Tree {
  ...
  get trees() {
    ...
    return [
      ...
      {
        requirement: 100,
        ts: [CONSTS.PRE_SPLIT, CONSTS.TIME, 111, PATH, 151, 161, 171, 162, CONSTS.EXTRA]
      },
      {
        requirement: 85,
        ts: [CONSTS.PRE_SPLIT, CONSTS.INFINITY, 111, PATH, 151, 161, 162, 21, 33, 31]
      },
      {
        requirement: 71,
        ts: [CONSTS.PRE_SPLIT, CONSTS.ANTIMATTER, 111, PATH, 151, 161, 21, 33, 31]
      },
      {
        requirement: 70,
        ts: [CONSTS.PRE_SPLIT, CONSTS.INFINITY, 111, PATH, 21, 33, 31, 41]
      },
      {
        requirement: 54,
        ts: [CONSTS.PRE_SPLIT, CONSTS.ANTIMATTER, 111, PATH, 21, 31]
      },
      // Early Eternity
      {
        requirement: 52,
  ...
  generateTree() {
    for (const tree of this.trees) {
      if (this.theorems >= this.requirement) {
